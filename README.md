// пофіксити на майбутнє: 
зміни у графіку ті що відбулись під час вимкнень або після вимкнень(ті що вже фактично відбулись або тривають) - не витирати. 
Або змінити логіку по іншому. Скрипт ЧАСТКОВО працює. Але не так як планувалось.

// формат апішки

[
  {
    "eventDate": "19.11.2025",
    "queues": {
      "6.1": [
        {
          "shutdownHours": "10:00-13:30",
          "from": "10:00",
          "to": "13:30",
          "status": 1
        },
        {
          "shutdownHours": "17:00-20:30",
          "from": "17:00",
          "to": "20:30",
          "status": 1
        }
    ...
    "createdAt": "19.11.2025 08:26",
    "scheduleApprovedSince": "19.11.2025 09:52"
  }
]
...
**Дуже важливо. Не встановлюйте значення інтервалу < 60. Апішка від світлобота блокуватиме айпі адреси хостів, запити яких надсилатимуться кожні 30 і менше секунд**
