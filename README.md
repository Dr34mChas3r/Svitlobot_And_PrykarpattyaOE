20.11 Даний скрипт більше не получатиме апдейти, оскільки знайдено нормальне рішення. Це архівується!
t.me/@DtekSchedulePowerOutSenderBot
// формат апішки
...
Зроблено за допомогою Claude.ai. 
